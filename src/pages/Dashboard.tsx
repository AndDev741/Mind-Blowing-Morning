...
export default function Dashboard() {
  ...
  return (
    <section className="w-4/5 mx-auto">
      ...
      <div>
        <div>
          <div className="font-bold w-[521px] h-[257px] bg-[#FFF5EF] border border-[#F47D31] rounded-2xl flex flex-col items-center justify-center box-border">
            ...
            <Link
              to="/courses"
              className="w-[429px] h-[50px] bg-primaryOrange rounded-2xl text-xl text-white flex items-center justify-center"
            >
