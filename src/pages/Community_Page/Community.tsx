  ...
  return (<>
    ...
    <div className='section w-full flex justify-center items-center my-10'>
      <div className="container">
          ...
          <div className="links">
            <div className="link w-[100%]">
              ...
              <div className="Links border-b mr-10">
                <Link to={"/"} className="flex justify-between w-[401px] my-5"><span style={{ fontSize: "1.6rem" }}>13 Reasons why ?<br />
        ...
        <div className="Bg my-4 flex items-end">
          <div className=""><Button className=" px-12 py-[1rem] mb-[8.2rem] ml-6" style={{borderRadius:"30px"}}>Get Started</Button></div>
        </div>
      </div>
    </div>
  </>
